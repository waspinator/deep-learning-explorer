'''
Mostly unchaged from:
https://github.com/aurora95/Keras-FCN/blob/master/utils/SegDataGenerator.py

_get_batches_of_transformed_samples() modified to use Dataset class to
...
class SegDirectoryIterator(Iterator):
    ...
    def __init__(self, dataset, file_path, seg_data_generator,
        ...
        # REPLACED, using dataset instead
        #fp = open(file_path)
        #lines = fp.readlines()
        # fp.close()
        ...
        self.nb_sample = len(self.dataset.image_ids)
    ...
    def _get_batches_of_transformed_samples(self, index_array):
        ...
        for i, j in enumerate(index_array):
            ...
            img = load_img(self.dataset.image_reference(j),
                           grayscale=grayscale, target_size=None)
            ...
            #label.save('{}.png'.format(random.randint(10000, 99999)))
            ...
            if self.target_size:
                if self.crop_mode != 'none':
                    ...
                    if self.data_format == 'channels_first':
                        ...
                        x = np.lib.pad(x, ((pad_h // 2, pad_h - pad_h // 2), (pad_w // 2,
                                                                              pad_w - pad_w // 2), (0, 0)), 'constant', constant_values=0.)
                        y = np.lib.pad(y, ((pad_h // 2, pad_h - pad_h // 2), (pad_w // 2, pad_w -
